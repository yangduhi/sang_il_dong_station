  ...
  return (
    <div className="space-y-4">
      {rows.map((row) => (
        <div
          key={row.hourBucket}
          className="grid gap-3 rounded-[22px] border border-white/[0.08] bg-black/[0.16] px-4 py-3 md:grid-cols-[72px_1fr_1fr] md:items-center"
        >
          <div className="font-display text-sm font-medium text-slate-200">{row.hourBucket}</div>
