...
export const sampleOverview: StationOverviewResponse = {
  ...
  meta: {
    ...
    limitations: [
      ...
      "OD는 상일동역 기준이 아니라 상일동 생활권 기준으로 해석합니다."
    ],
    queryEcho: {
...
export const sampleOriginToZone: OdOriginToZoneResponse = {
  data: {
    ...
    rows: [
      ...
      { zoneName: "하남·구리·남양주", passengerCount: 3010, sharePct: 14.5, topContextLabel: "하남시 덕풍동" },
      ...
      { zoneName: "서북", passengerCount: 664, sharePct: 3.2, topContextLabel: "마포구 상암동" },
...
export const sampleZoneToDestination: OdZoneToDestinationResponse = {
  data: {
    ...
    rows: [
      ...
      { zoneName: "하남·구리·남양주", passengerCount: 4460, sharePct: 21.5, topContextLabel: "하남시 신장동" },
...
export const sampleQuality: DataQualitySummaryResponse = {
  data: {
    ...
    sourceMode: "sample",
    warnings: [
      "현재 화면은 local/sample fallback 으로 구동하고 있습니다.",
      "승하차는 역 단위, OD는 생활권 단위로 해석하고 있습니다."
    ],
    metrics: [
